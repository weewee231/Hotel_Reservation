...
import school.gera.reservationsystem.reservations.availability.ReservationAvailabilityService;
...
public class ReservationService {
    ...
    public Reservation getReservationById(Long id) {
        ...
        return mapper.toDamain(reservationEntity);
    }
    ...
    public Reservation updateReservation(Long id, Reservation reservationToUpdate) {
        ...
        return mapper.toDamain(updatedReservation);
    }
    ...
    public Reservation approveReservation(Long id) {
        ...
        var isAvailableToApprove = availabilityService.isResevationAvailable(
